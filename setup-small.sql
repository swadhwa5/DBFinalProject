...
LOAD DATA LOCAL INFILE './State-small.txt' 
INTO TABLE "State";

LOAD DATA LOCAL INFILE './WaterBody-small.txt' 
INTO TABLE WaterBody;

LOAD DATA LOCAL INFILE './BotanicalGarden-small.txt' 
INTO TABLE BotanicalGarden;

LOAD DATA LOCAL INFILE './GrowsIn-small.txt' 
INTO TABLE GrowsIn;

LOAD DATA LOCAL INFILE './ThreatenedPlant-small.txt' 
INTO TABLE ThreatenedPlant;

LOAD DATA LOCAL INFILE './FloweringPlant-small.txt' 
